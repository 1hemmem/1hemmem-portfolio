...
function ProjectCard(props) {
    return (
        <div>
            <div>
                <h1 className="text-2xl font-bold dark:text-white  mb-4">{props.Title}</h1>
            </div>
            ...
            <br />
            <br />
            <a href={props.Link} target="_blank" className="underline font-semibold text-sm flex items-center gap-2 hover:font-bold hover:text-gray-600"><svg
                aria-hidden="true"
                focusable="false"
                height="24"
                role="presentation"
