...
export const CertificateCard = (props) => {
  ...
  return (
    <div className="relative block max-w-xs p-4 m-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-zinc-900 dark:border-gray-700">
      {/* Positioned Icons */}
      <div className="relative h-12">
        ...
        >
          <img className="h-8 w-8 invert" src={img} alt="Link icon" />
        </a>
      ...
      <button
        ...
        className="mt-2 text-sm font-semibold text-white hover:underline flex items-center space-x-2"
      >
